...
<link href="<c:url value="${pageContext.request.contextPath }/styles/bootstrap/css/main.css" />" type="text/css"
    rel="stylesheet" />
<title>查看个人信息</title>
<link href="<c:url value="../styles/bootstrap/css/bootstrap.min.css"/>"  type="text/css" rel="stylesheet" />
</head>
<body>
